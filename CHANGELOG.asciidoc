...
*Release date: *
* GUI revamp.
* Toggle for show either resource's mass or amount.
* Toggle for show either vessel's dry or fuel mass.
* Disable plugin when in crew/action screens.
* Separate Rotation and Translation modes into their own tab.
* Allow using a marker as reference even when is not visible.
