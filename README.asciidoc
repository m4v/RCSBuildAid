...
*Dry Mass/Fuel Mass*: Mass of the vessel without fuel / Mass of the fuel 
(click to toggle).

*DCoM offset*: Distance between the CoM and the DCoM.
...
* Delta V readout for RCS isn't accurate for modded RCS. In these situations 
the dV readout will not be shown.
